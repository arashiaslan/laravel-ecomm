    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            enctype="multipart/form-data">
                ...
                @error('name') <span class="alert alert-danger tect-center">{{$message}}</span> @enderror
                <fieldset class="name">
                ...
                @error('slug') <span class="alert alert-danger tect-center">{{$message}}</span> @enderror
                <fieldset>
                ...
                @error('image') <span class="alert alert-danger tect-center">{{$message}}</span> @enderror
                <div class="bot">
                    <div></div>
